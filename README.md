...
## Features
윤동주체 시 생성기는 딥러닝 LSTM(Long Short Term Memory networks) 모델을 활용하여 문맥을 반영해서 텍스트를 생성하는 모델을 통해 윤동주 시인의 문체를 구현하였다. 
LSTM 모델의 학습 데이터는 윤동주 시인의 유고 시집인 '하늘과 바람과 별과 시'로 1941년에 출간될 예정이었던 19편의 시들이다. 
